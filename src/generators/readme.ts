import { ProjectInfo } from "../analyzers/project.js";
...
function getBadgeColor(language: string): string {
...
export function generateReadme(info: ProjectInfo, options: ReadmeOptions): string {
  ...
  parts.push("");
  parts.push(
    `${badge("Language", getLanguageLabel(info.language), getBadgeColor(info.language))} ` +
